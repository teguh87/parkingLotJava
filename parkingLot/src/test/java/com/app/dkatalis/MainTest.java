...
public class MainTest {
    ...
    public void alreadyExistParkingLot() throws Exception
    {
        ...
        thrown.expectMessage(is(Code.PARKING_ALREADY_EXIST.getMessage()));
        instance.createParkingLot(parkingLevel, 65);
        instance.doCleanup();
    }
    ...
    public void testParkingCapacity() throws Exception
    {
        ParkingService instance = new ParkingServiceImpl();
        thrown.expect(ProcessException.class);
        thrown.expectMessage(is(Code.PARKING_NOT_EXIST_ERROR.getMessage()));
        instance.park(parkingLevel, new Car("KA-01-HH-1234"));
        assertEquals("Sorry,CarParkingDoesnotExist", outContent.toString().trim().replace(" ", ""));
        instance.createParkingLot(parkingLevel, 11);
        instance.park(parkingLevel, new Car("KA-01-HH-1234"));
        instance.park(parkingLevel, new Car("KA-01-HH-9999"));
        instance.park(parkingLevel, new Car("KA-01-BB-0001"));
